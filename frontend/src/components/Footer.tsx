  ...
  return (
    <footer className="border-t border-slate-200 bg-white">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-[1.4fr_1fr_1fr] lg:px-8">
        ...
        <div>
          <h2 className="text-sm font-bold uppercase text-thyro-navy">
        ...
        <div>
          <h2 className="text-sm font-bold uppercase text-thyro-navy">
            {tr("footer.quickLinks", "Quick Links")}
          </h2>
      ...
      <div className="border-t border-slate-200 bg-slate-50 px-4 py-4 text-center text-xs font-medium text-slate-500">
        {tr("footer.copyright", "Copyright 2026 THYRO LABORATORIES. All rights reserved.")}
      </div>
    </footer>
  );
};
